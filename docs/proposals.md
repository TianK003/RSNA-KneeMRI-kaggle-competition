...
| P-28 | **Production training regime: all 4,349 studies, 16 epochs, SWA of the last 3 EMA snapshots** | 🔁 **measured 2026-09-22**: `v09a` / `v08a` add −0.001 on the LB (#14 vs #13); P-29 shows 16 epochs over-trains by ≈ 0.012 OOF → **`epochs` 16 → 8 for future members**; all-data + SWA themselves unmeasured | medium — the regime minus its epoch budget | 2 × one T4 session (spent) | P-25/P-26; P-29 |
