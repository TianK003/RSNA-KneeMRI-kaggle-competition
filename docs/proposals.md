...
| P-28 | **Production training regime: all 4,349 studies, 16 epochs, SWA of the last 3 EMA snapshots** | ⏳ **S2 retrain running — `rsna-knee-train` v26 (pushed 2026-09-23 09:05, ≈ 2.8 h, both T4s)**: `v09a` = 8 ep + the S1 knobs (`batch_studies=2, grad_accum=2, aug="light"`), `v08a` = 8 ep; smoke v25 green. Then ship → fork β 0.10 vs 0.942. Earlier 🔁 **measured 2026-09-22**: the 16-ep `v09a` / `v08a` add −0.001 on the LB (#14 vs #13); P-29 → `epochs` 8 | medium — the regime minus its epoch budget | 2 × one T4 session (spent) | P-25/P-26; P-29 |
...
Status: ⏳ **S2 retrain running 2026-09-23 — `rsna-knee-train` v26 (pushed 09:05 on Tian's go, `PARALLEL_ARMS = ("v09a", "v08a")`, one
arm per T4, ≈ 2.8 h)**: `v09a` = `PROD` (8 ep, SWA 5–7) + the S1 knobs `batch_studies=2, grad_accum=2, aug="light"` (P-32 / P-33, both 🔁
