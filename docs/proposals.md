...
| P-28 | **Production training regime: all 4,349 studies, 16 epochs, SWA of the last 3 EMA snapshots** | ✅ **S2 retrained 2026-09-23 (train v26, 2.64 h both T4s) → experiments.md "S2 production retrain"**: `v09a` (8 ep + S1 knobs) gold-58 SWA **0.8922** (16-ep 0.8768), `v08a` (8 ep) **0.8850** (0.8816) — both still rising at epoch 7 (no peak-and-drift), gold deltas direction-only; shipped as new Dataset versions; **LB ⏳ #17** (fork v8, β 0.10 vs 0.942). Earlier 🔁 (2026-09-22): the 16-ep members −0.001 on the LB (#14 vs #13); P-29 → `epochs` 8 | medium — the regime minus its epoch budget | 2 × one T4 session (spent) | P-25/P-26; P-29 |
...
0.05). Shipped 11:44 (Datasets re-versioned); fork v8 (β 0.10, `v08w v09h v09a v08a`) → **submission #17 ⏳** vs 0.942. Was: ⏳ S2
