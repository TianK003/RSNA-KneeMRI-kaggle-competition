...
Status:       ⏳ **running — `rsna-knee-folds` v8 (pushed 2026-09-23 12:45 on Tian's go, ≈ 3.3 h, both T4s)**; read ≈ 15:30 by this card's Measure. Same smoke session as P-34 (`rsna-knee-folds` v7, `v08c` on
