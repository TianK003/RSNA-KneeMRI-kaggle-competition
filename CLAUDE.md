...
a **0.006 band**, from 2,559 teams. **We are at 0.909** (2026-08-30 evening, submission #9: two DINOv2 heads + five concat folds + one ConvNeXt-T + `v08w` + `v10c` on the c02 cache, one vote per version; 0.900 before the c02 members; 0.877 for the best single model on the LB). The Efficiency Prize has its own leaderboard, published
