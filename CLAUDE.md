...
kaggle/rsna-knee-teacher/   GENERATED by src/build_teacher_pass.py -- the Raptor teacher pass over training-study chunks (committed render = shard 0/3 of the FULL pass, LIMIT 0: a push starts a ~2.5 h session; v4 = shard 0, done 2026-09-24, output pulled; shard 2 reuses this dir + slug)
