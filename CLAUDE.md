...
kaggle/rsna-knee-teacher/   GENERATED by src/build_teacher_pass.py -- the Raptor teacher pass over training-study chunks (committed render = the LIMIT-100 spike, v3)
