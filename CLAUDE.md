...
kaggle/rsna-knee-teacher/   GENERATED by src/build_teacher_pass.py -- the Raptor teacher pass over training-study chunks (committed render = shard 0/2 of the FULL pass, LIMIT 0: a push starts a ~3.1 h session; the spike was v3)
kaggle/rsna-knee-teacher-b/ GENERATED with --slug tiankljucanin/rsna-knee-teacher-b -- shard 1/2 of the full pass for the second GPU slot; never pushed yet (the first push creates the kernel)
