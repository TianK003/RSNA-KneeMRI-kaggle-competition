...
kaggle/rsna-knee-teacher/   GENERATED by src/build_teacher_pass.py -- the Raptor teacher pass over training-study chunks (committed render = shard 0/3 of the FULL pass, LIMIT 0: a push starts a ~2.1 h session; v4 = that shard, running 2026-09-24; the spike was v3)
kaggle/rsna-knee-teacher-b/ GENERATED with --slug tiankljucanin/rsna-knee-teacher-b -- shard 1/3 of the full pass for the second GPU slot (v1 pushed 2026-09-24 14:54)
